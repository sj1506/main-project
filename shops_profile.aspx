...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
      ...
      <div class="col-sm-12" style="    margin-top: 8px">
         ...
         <div class="col-sm-6">
             <asp:TextBox ID="txt_phone3" runat="server"></asp:TextBox>
         </div>
      </div>
          <div class="col-sm-12" style="    margin-top: 8px">
           <div class="col-sm-6">
         ...
         <div class="col-sm-6">
             <asp:TextBox ID="txt_mobile3" runat="server"></asp:TextBox>
         </div>
      </div>
           <div class="col-sm-12" style="    margin-top: 8px">
           <div class="col-sm-6">
         ...
         <div class="col-sm-6">
             <asp:TextBox ID="mail2" runat="server"></asp:TextBox>
         </div>
      </div> 
           <div class="col-sm-12" style="    margin-top: 8px">
           <div class="col-sm-6">
         ...
         <div class="col-sm-6">
             <asp:TextBox ID="tin_no" runat="server"></asp:TextBox>
         </div>
      </div>
       <div class="col-sm-12" style="    margin-top: 8px">
           <div class="col-sm-6">
        ...
        <div class="col-sm-12" style="    margin-top: 8px">
         ...
         <div class="col-sm-6">
             <asp:TextBox ID="cin_no" runat="server"></asp:TextBox>
         </div>
      </div>
          <div class="col-sm-12" style="    margin-top: 8px">
           <div class="col-sm-6">
         ...
         <div class="col-sm-6">
             <asp:TextBox ID="servicetaxno" runat="server"></asp:TextBox>
         </div>
      </div>
